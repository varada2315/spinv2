...
export default function VisaServicesSection({ onVisaClick }) {
  const visaCountries = [
    ...
    { country: 'Schengen', flagCode: 'eu', type: '27 European Nations' },
    ...
    { country: 'Russia', flagCode: 'ru', type: 'E-Visa & Tourist Stamp' },
    ...
    { country: 'Saudi Arabia', flagCode: 'sa', type: 'Umrah & Tourist EVisa' },
